      ...
      <form class="form-horizontal" method="get">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            </select><div class="chosen-container chosen-container-single" style="width: 648px;" title=""><a class="chosen-single" tabindex="-1"><span>Alaska</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off"></div><ul class="chosen-results"></ul></div></div>
          </div>
        </div>
